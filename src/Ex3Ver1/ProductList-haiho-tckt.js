...
export default class ProductList extends Component {
  ...
  state = { selectedItem: null, isShowCart: false};
  ...
  render() {
    return (
      <div>
        {/* trong react, để gán sự kiện onlick cho button, thì phải để 1 hàm không tên trước khi gọi hàm chính chạy */}
        {/* onClick = {() => this.handleClick()}   điều này có nghĩa là mình bắt sự kiện click của người dùng */}
        {/* onClick = {this.handleClick()}    còn nếu không có hàm không tên thì vừa vào nó chạy luôn và chạy bất chấp, sẽ làm web bị đứng*/}
        {/* onClick = {this.hangleClick}   trong JSX, mình chuyển 1 hàm làm trình xử lý sự kiện thay vì 1 chuỗi như bên HTML*/}
        <h1
        ...
        {this.state.isShowCart && <Cart hideCart={this.hideCart}/>}
      </div>
    );
  }
}
