...
const chairReducer = (state = initialState, action) => {
  switch (action.type) {
    case "CHANGE_CHAIR": {
      ...
      //kiểm tra trong mảng chair selected đã tồn tại ghế hay chưa
      //findIndex: nếu có thỉ trả về index của item đúng với điều kiện, ngược lại trả về -1
      ...
      return { ...state, chairSelectedList: data };
    }
    ...
    case 'PAY': {
      ...
      return { ...state, chairList: data, chairSelectedList: [] }
  }
